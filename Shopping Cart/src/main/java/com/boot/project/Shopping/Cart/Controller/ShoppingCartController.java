...
public interface ShoppingCartController {
	...
	@DeleteMapping(value = "/api/delete/product", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
	ResponseEntity<CartResponse> deleteProduct(@RequestBody List<Integer> productId);

	@GetMapping(value = "/api/get/cart/{cartNo}", produces = MediaType.APPLICATION_JSON_VALUE)
